 ...
 */
@WebServlet(name = "ControllerPrintSearch", urlPatterns = {"/controllerPrintSearch"})
public class ControllerPrintSearch extends HttpServlet {
        ...
        try {
            try {
                ...
                try {
                    ...
                    List<Object> datas = (List<Object>) new SetujuCutiDAO().search("Status", "Ditolak");
                    int i = 1;
